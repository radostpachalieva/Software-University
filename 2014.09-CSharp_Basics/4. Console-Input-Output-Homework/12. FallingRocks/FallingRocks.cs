...
// https://github.com/AniSoft/SoftwareUniversity/blob/master/CSharpBasic/04.ConsoleInputOutputHomework/12.FallingRocks
            ...
            while (true)
            {
                ...
                for (int i = 0; i < rocks.Count; i++)
                {
                    ...
                    if (newRock.y == dwarf.y)
                    {
                        ...
                        {
                            if ((newRock.x + j == dwarf.x) || 
                                (newRock.x + j == dwarf.x + 1) || 
                                (newRock.x + j == dwarf.x + 2))
                            {
                                isDead = true;
                                break;
                            }
